...
//	     }
	...
	//=======================================================
	  ...
	  //=====================================================
	//  public void highCredit(SinglyLinkedList currenStudents)
	//  {
	//  if(currenStudents.head==null)
//	      return;
	//   
	//  curr=currenStudents.head;
	//  while(curr!=null){
	//
	//  student s=(student)curr.getElement();
//	     if((int)s.getGrade()>100)
//	     {
	//  if(head==null)
